...
- A fork of 'PX4-Autopilot' repo is uploaded here in this repo for personal uses (may or may not be useful) [here](), the currently used firmware version even for hardware is: v1.14.3 

...
- Install Ubuntu Mate (version: 22.04), a mimimal Ubuntu desktop type OS optimized for raspi. An ubuntu server version + Lubuntu GUI would also be more than fine for this
...
- A fork of 'PX4-Autopilot' repo is uploaded here in this repo for personal uses (may or may not be useful) [here](https://github.com/Labeeb1234/PX4-Autopilot), the currently used firmware version even for hardware is: v1.14.3 

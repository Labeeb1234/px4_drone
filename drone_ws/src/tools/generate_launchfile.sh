...
cat > /home/inlab/catkin_ws/src/avoidance/local_planner/launch/avoidance.launch <<- EOM
<launch>
    <arg name="ns" default="/"/>
...
cat > /home/inlab/catkin_ws/src/avoidance/local_planner/resource/rqt_param_toggle.sh <<- EOM
#!/bin/bash
...
for camera in $CAMERA_CONFIGS; do
    ...
    cat >> /home/inlab/catkin_ws/src/avoidance/local_planner/launch/avoidance.launch <<- EOM
      ...
      <node name="drop_$1_ir" pkg="topic_tools" type="drop" output="screen"
		...
		" >> /home/inlab/catkin_ws/src/avoidance/local_planner/resource/rqt_param_toggle.sh
...
# Set the frame rate in the  file as well
sed -i '/stream-fps/c\    \"stream-fps\": \"'$DEPTH_CAMERA_FRAME_RATE'\",' /home/inlab/catkin_ws/src/avoidance/local_planner/resource/stereo_calib.json
